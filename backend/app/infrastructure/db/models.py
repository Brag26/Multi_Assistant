...
class CallModel(Base):
    ...
    ended_reason: Mapped[str | None] = mapped_column(String(60))  # Vapi's endedReason (e.g. "customer-did-not-answer")
    ...
    success_evaluation: Mapped[str | None] = mapped_column(Text)
